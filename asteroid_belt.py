...
def getForceBetween(satellite1: Satellite, satellite2: Satellite):
    """
...
def getTangent(loc1, loc2) -> pygame.Vector2:
    """
    returns a normalized vector tangent to the vector described by loc1 - loc2.
    """
    vector = loc1 - loc2
    return pygame.Vector2(vector.y, -vector.x) / vector.magnitude()
